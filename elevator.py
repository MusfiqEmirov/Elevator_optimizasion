...
open_text = "qapi acilir"
close_text = "qapi baglanir"

elevator_up_text = "list yuxari qalxir"
elevator_down_text = "list awagi duwur"
...
class Elevator:
    ...
    def elevator_with_person(self, person: Person):
        print(
            f"liftin oldugu yer>>{self.current_floor} "
            f"\nserniwinin oldugu yer>> {person.p_current_floor} "
            f"\nserniwin getmey istyediyi yer>>{person.p_target_floor}"
        )
